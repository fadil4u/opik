...
Opik supports cost tracking for **500 models** across **7 providers**:

- **[AWS Bedrock](#aws-bedrock)**: 210 models
- **[Anthropic](#anthropic)**: 22 models
- **[Anthropic on Vertex AI](#anthropic-on-vertex-ai)**: 33 models
- **[Google AI](#google-ai)**: 50 models
- **[Google Vertex AI](#google-vertex-ai)**: 35 models
- **[Groq](#groq)**: 11 models
