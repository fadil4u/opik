...
Opik supports cost tracking for **574 models** across **7 providers**:

- **[AWS Bedrock](#aws-bedrock)**: 270 models
- **[Anthropic](#anthropic)**: 20 models
- **[Anthropic on Vertex AI](#anthropic-on-vertex-ai)**: 34 models
- **[Google AI](#google-ai)**: 62 models
- **[Google Vertex AI](#google-vertex-ai)**: 38 models
- **[Groq](#groq)**: 7 models
- **[OpenAI](#openai)**: 143 models

<h2 id="aws-bedrock">AWS Bedrock</h2>

Models hosted by AWS Bedrock • [Learn more](https://aws.amazon.com/bedrock)

**270 models supported**
