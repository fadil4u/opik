...
Opik supports cost tracking for **456 models** across **7 providers**:

- **[AWS Bedrock](#aws-bedrock)**: 174 models
- **[Anthropic](#anthropic)**: 26 models
- **[Anthropic on Vertex AI](#anthropic-on-vertex-ai)**: 25 models
- **[Google AI](#google-ai)**: 43 models
- **[Google Vertex AI](#google-vertex-ai)**: 51 models
- **[Groq](#groq)**: 10 models
