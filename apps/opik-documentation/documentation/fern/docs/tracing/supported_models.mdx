...
Opik supports cost tracking for **511 models** across **7 providers**:

- **[AWS Bedrock](#aws-bedrock)**: 189 models
- **[Anthropic](#anthropic)**: 25 models
- **[Anthropic on Vertex AI](#anthropic-on-vertex-ai)**: 28 models
- **[Google AI](#google-ai)**: 60 models
- **[Google Vertex AI](#google-vertex-ai)**: 56 models
- **[Groq](#groq)**: 11 models
- **[OpenAI](#openai)**: 142 models
