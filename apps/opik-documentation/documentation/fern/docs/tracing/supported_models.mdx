...
Opik supports cost tracking for **443 models** across **7 providers**:

- **[AWS Bedrock](#aws-bedrock)**: 169 models
- **[Anthropic](#anthropic)**: 22 models
- **[Anthropic on Vertex AI](#anthropic-on-vertex-ai)**: 24 models
- **[Google AI](#google-ai)**: 42 models
- **[Google Vertex AI](#google-vertex-ai)**: 49 models
- **[Groq](#groq)**: 10 models
