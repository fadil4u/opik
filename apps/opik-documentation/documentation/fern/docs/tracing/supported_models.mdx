...
Opik supports cost tracking for **542 models** across **7 providers**:

- **[AWS Bedrock](#aws-bedrock)**: 223 models
- **[Anthropic](#anthropic)**: 26 models
- **[Anthropic on Vertex AI](#anthropic-on-vertex-ai)**: 37 models
- **[Google AI](#google-ai)**: 57 models
- **[Google Vertex AI](#google-vertex-ai)**: 40 models
- **[Groq](#groq)**: 14 models
- **[OpenAI](#openai)**: 145 models

<h2 id="aws-bedrock">AWS Bedrock</h2>

Models hosted by AWS Bedrock • [Learn more](https://aws.amazon.com/bedrock)

**223 models supported**
