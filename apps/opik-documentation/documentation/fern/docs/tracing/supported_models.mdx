...
Opik supports cost tracking for **387 models** across **7 providers**:

- **[AWS Bedrock](#aws-bedrock)**: 131 models
- **[Anthropic](#anthropic)**: 20 models
- **[Anthropic on Vertex AI](#anthropic-on-vertex-ai)**: 22 models
- **[Google AI](#google-ai)**: 38 models
- **[Google Vertex AI](#google-vertex-ai)**: 43 models
- **[Groq](#groq)**: 27 models
- **[OpenAI](#openai)**: 106 models
