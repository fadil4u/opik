...
Opik supports cost tracking for **565 models** across **7 providers**:

- **[AWS Bedrock](#aws-bedrock)**: 231 models
- **[Anthropic](#anthropic)**: 26 models
- **[Anthropic on Vertex AI](#anthropic-on-vertex-ai)**: 37 models
- **[Google AI](#google-ai)**: 64 models
- **[Google Vertex AI](#google-vertex-ai)**: 43 models
- **[Groq](#groq)**: 15 models
- **[OpenAI](#openai)**: 149 models

<h2 id="aws-bedrock">AWS Bedrock</h2>

Models hosted by AWS Bedrock • [Learn more](https://aws.amazon.com/bedrock)

**231 models supported**
