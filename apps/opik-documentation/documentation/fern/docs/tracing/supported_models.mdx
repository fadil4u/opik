...
Opik supports cost tracking for **474 models** across **7 providers**:

- **[AWS Bedrock](#aws-bedrock)**: 199 models
- **[Anthropic](#anthropic)**: 20 models
- **[Anthropic on Vertex AI](#anthropic-on-vertex-ai)**: 29 models
- **[Google AI](#google-ai)**: 47 models
- **[Google Vertex AI](#google-vertex-ai)**: 29 models
- **[Groq](#groq)**: 11 models
- **[OpenAI](#openai)**: 139 models

<h2 id="aws-bedrock">AWS Bedrock</h2>

Models hosted by AWS Bedrock • [Learn more](https://aws.amazon.com/bedrock)

**199 models supported**
