...
Opik supports cost tracking for **434 models** across **7 providers**:

- **[AWS Bedrock](#aws-bedrock)**: 163 models
- **[Anthropic](#anthropic)**: 22 models
- **[Anthropic on Vertex AI](#anthropic-on-vertex-ai)**: 24 models
- **[Google AI](#google-ai)**: 40 models
- **[Google Vertex AI](#google-vertex-ai)**: 46 models
- **[Groq](#groq)**: 27 models
- **[OpenAI](#openai)**: 112 models

<h2 id="aws-bedrock">AWS Bedrock</h2>

Models hosted by AWS Bedrock • [Learn more](https://aws.amazon.com/bedrock)

**163 models supported**
