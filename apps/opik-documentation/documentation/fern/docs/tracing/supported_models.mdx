...
Opik supports cost tracking for **598 models** across **7 providers**:

- **[AWS Bedrock](#aws-bedrock)**: 251 models
- **[Anthropic](#anthropic)**: 28 models
- **[Anthropic on Vertex AI](#anthropic-on-vertex-ai)**: 39 models
- **[Google AI](#google-ai)**: 65 models
- **[Google Vertex AI](#google-vertex-ai)**: 44 models
- **[Groq](#groq)**: 15 models
- **[OpenAI](#openai)**: 156 models

<h2 id="aws-bedrock">AWS Bedrock</h2>

Models hosted by AWS Bedrock • [Learn more](https://aws.amazon.com/bedrock)

**251 models supported**
