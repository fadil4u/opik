...
Opik supports cost tracking for **493 models** across **7 providers**:

- **[AWS Bedrock](#aws-bedrock)**: 209 models
- **[Anthropic](#anthropic)**: 22 models
- **[Anthropic on Vertex AI](#anthropic-on-vertex-ai)**: 33 models
