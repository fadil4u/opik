...
Opik supports cost tracking for **485 models** across **7 providers**:

- **[AWS Bedrock](#aws-bedrock)**: 204 models
- **[Anthropic](#anthropic)**: 21 models
- **[Anthropic on Vertex AI](#anthropic-on-vertex-ai)**: 31 models
- **[Google AI](#google-ai)**: 48 models
- **[Google Vertex AI](#google-vertex-ai)**: 31 models
- **[Groq](#groq)**: 11 models
