...
Opik supports cost tracking for **452 models** across **7 providers**:

- **[AWS Bedrock](#aws-bedrock)**: 193 models
- **[Anthropic](#anthropic)**: 18 models
- **[Anthropic on Vertex AI](#anthropic-on-vertex-ai)**: 27 models
